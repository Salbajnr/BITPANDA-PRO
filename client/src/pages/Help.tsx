  ...
  const faqs = [
    {
      ...
      answer: "Account verification typically takes 1-3 business days. You'll receive an email once your account is verified."
    },
    {
      question: "What are the trading fees?",
      answer: "Our trading fees start at 0.1% per transaction and decrease based on your trading volume and VIP level."
    },
    {
      question: "Is my money safe on this platform?",
      answer: "Yes, we use bank-level security measures including cold storage for 95% of funds and full regulatory compliance."
    },
    {
      question: "Can I trade on mobile?",
      answer: "Yes, we offer full-featured mobile apps for both iOS and Android with all desktop functionality."
    }
  ];
                ...
                <CardContent>
                  <ul className="space-y-2">
                    {category.articles.map((article, articleIndex) => (
                      <li key={articleIndex} className="text-sm text-muted-foreground hover:text-primary cursor-pointer">
                        • {article}
                      </li>
                    ))}
                  </ul>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="flex items-center gap-3 p-4 border border-border rounded-lg">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">support@bitpanda.com</p>
                  </div>
                </div>
                <div className="flex items-center gap-3 p-4 border border-border rounded-lg">
