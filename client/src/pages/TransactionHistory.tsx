...
export default function TransactionHistory() {
  ...
  const { data: transactions = [], isLoading, refetch } = useQuery({
    queryKey: ['/api/transactions', typeFilter, statusFilter, dateRange],
    queryFn: async () => {
            ...
            <div className="mb-6 flex items-center justify-between">
              <div>
                ...
                <p className="text-slate-600 dark:text-slate-400">
                  View and track all your trading activities
                </p>
              </div>
                ...
                {isLoading ? (
                  ...
                  <div className="overflow-x-auto">
                    <table className="w-full">
                      ...
                      <tbody>
                        {filteredTransactions.map((transaction: Transaction) => (
                          <tr key={transaction.id} className="border-b border-gray-100 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-800">
