...
import { chatWebSocketManager } from './chat-websocket.js';
...
import portfolioAnalyticsRoutes from './portfolio-analytics-routes.js';
import metalsRoutes from './metals-routes.js';
import newsRoutes from './news-routes.js';
import kycRoutes from './kyc-routes.js';
import marketResearchRoutes from './market-research-routes.js';
import chatRoutes from './chat-routes.js';
import investmentPlansRoutes from './investment-plans-routes.js';
import savingsPlansRoutes from './savings-plans-routes.js';
...
app.use(cookieParser(process.env.COOKIE_SECRET || "cookie-secret-key-must-be-32ch"));

// IMPORTANT: You should change this secret to a value from your environment variables
const csrfProtection = csrf({
    secret: process.env.CSRF_SECRET || "csrf-secret-key-must-be-32-char",
    cookieName: "_csrf",
